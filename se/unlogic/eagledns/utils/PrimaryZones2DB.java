...
public class PrimaryZones2DB {
   ...
   public static void importZones(String directory, String driver, String url, String username, String password) throws Throwable {
      ...
      AnnotatedDAO<DBZone> zoneDAO = new AnnotatedDAO(dataSource, DBZone.class, annotatedDAOFactory);
      AnnotatedDAO<DBRecord> recordDAO = new AnnotatedDAO(dataSource, DBRecord.class, annotatedDAOFactory);
      ...
      try {
         for(DBZone zone : dbZones) {
            ...
            zoneDAO.add(zone, transactionHandler, (RelationQuery)null);

            for(DBRecord dbRecord : zone.getRecords()) {
               System.out.println("Storing record " + dbRecord + "...");
               dbRecord.setZone(zone);
               recordDAO.add(dbRecord, transactionHandler, (RelationQuery)null);
            }
         }
