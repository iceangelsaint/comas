         ...
         if (f != null && f.length > 0) {
            ...
            if (!this.waitForState(p, 300)) {
               ...
               if ((dsink = this.createDataSink(p, outML)) == null) {
                  System.err.println("Failed to create a DataSink for the given output MediaLocator: " + String.valueOf(outML));
                  return false;
               } else {
   ...
   DataSink createDataSink(Processor p, MediaLocator outML) {
      ...
      if ((ds = p.getDataOutput()) == null) {
         ...
         try {
            ...
            System.err.println("Cannot create the DataSink: " + String.valueOf(e));
            return null;
         }
      }
   }
   ...
   static MediaLocator createMediaLocator(String url) {
      ...
      if (url.indexOf(":") > 0 && (ml = new MediaLocator(url)) != null) {
         ...
         if (url.startsWith(File.separator)) {
            ...
            String file = "file:" + var10000 + File.separator + url;
