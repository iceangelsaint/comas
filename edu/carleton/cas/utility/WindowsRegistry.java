...
public class WindowsRegistry {
   ...
   public static void main(String[] args) {
      ...
      String value = readRegistry("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Shell Folders", "Personal");
      System.out.println("Personal=" + value + ".");
      value = readRegistry("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Shell Folders", "Desktop");
